...
|1.2      |15.05.2026  |Colin Dietschmann                              |Design verbesserungen und hinzufügen der Modultabelle|
---

## Inhaltsverzeichnis

1. [Einleitung & Modultabelle](#1-einleitung--vision)
...
| **SemanticID Routing & CirrusSearch** | JavaScript | Verbesserte Suchfunktion nach der SemanticID | Colin Dietschmann & Marina Hidalgo Burova | [README - SemanticID Routing](https://github.com/DHBW-TINF24F/Team4-Semantic-Wikibase/blob/main/wikibase_semanticid/README.md) | [MOD 10 Suchfunktion & SemanticID Suche](https://github.com/DHBW-TINF24F/Team4-Semantic-Wikibase/blob/main/PROJECT/TINF24F_4-MOD-Semantic-Wikibase-0v1.md#10-suchfunktion-und-semanticid-suche)
| **API Gateway** | Python, FastAPI, `requests` | Zentrale Schnittstelle zur Bündelung der einzelnen Mapper-APIs. Leitet Suchanfragen an die QUDT-, VEC- und KBL-Mapping-Module weiter und liefert die Ergebnisse gesammelt zurück. | Marvin Igrec | [api_gateway.py](https://github.com/DHBW-TINF24F/Team4-Semantic-Wikibase/blob/main/SOURCE/API_gateway) | [MOD 3 API-Architektur](TINF24F_4-MOD-Semantic-Wikibase-0v1.md#3-architektur-der-api), [MOD 5 Mapping-Vergleich](TINF24F_4-MOD-Semantic-Wikibase-0v1.md#5-gemeinsames-mapping-über-alle-quellen) |
